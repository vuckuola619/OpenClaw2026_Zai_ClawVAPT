...
export interface Job { id: string; userIdHash: string; targetUrl: string; verified: boolean; scopeLocked: boolean; scopeHost: string; state: string; freeScanUsed: boolean; credits: number; findings: Finding[]; orderId?: string; repoUrl?: string; repoPath?: string; repoCommit?: string; ownershipToken?: string; verificationMethod?: 'demo' | 'http' | 'dns'; verifiedAt?: string; createdAt?: string; updatedAt?: string; }
