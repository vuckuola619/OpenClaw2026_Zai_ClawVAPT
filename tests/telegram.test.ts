...
test('telegram command skeleton includes required user commands', () => {
  for (const command of ['/start','/help','/scan <url>','/verify <job_id>','/status <job_id>','/my_jobs','/latest','/report <job_id>','/harden <job_id>','/pay','/check_payment <order_id>','/simulate_payment <order_id>','/demo']) {
